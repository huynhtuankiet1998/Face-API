...
var InputBoxComponent = /** @class */ (function () {
    function InputBoxComponent(activeModal) {
        this.activeModal = activeModal;
        this.inputValue = '';
    }
    InputBoxComponent.prototype.ngOnInit = function () { };
    InputBoxComponent.prototype.save = function () {
...
var InputModalProperties = /** @class */ (function () {
    function InputModalProperties() {
    }
    return InputModalProperties;
}());
